...
#include <soc/qcom/camera2-legacy-n.h>
...
int legacy_n_msm_camera_enable_irq(struct resource *irq, int flag);
...
int legacy_n_msm_camera_put_reg_base(struct platform_device *pdev, void __iomem *base,
		char *device_name, int reserve_mem);
